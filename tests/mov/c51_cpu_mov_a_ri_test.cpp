...
/** @file
 *
 * This file defines test for C51 CPU instruction set MOV A, @Ri
 */
...
int main(int argc, char ** argv)
{
    try
    {
        c51_cpu CPU(PROJECT_BINARY_DIR "/ihx_output/mov_a_ri.ihx");
        //////////////////////////////////////////////////////////////////
        CPU.exec();
        CPU.exec();
        CPU.exec();
